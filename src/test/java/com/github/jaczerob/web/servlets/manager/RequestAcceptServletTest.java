...
import com.github.jaczerob.project1.web.servlets.manager.RequestAcceptServlet;
import com.github.jaczerob.utils.ServletTestHelper;

public class RequestAcceptServletTest extends ServletTestHelper {
    @Mock protected Manager manager;

    @Override
    protected void setServlet() {
        this.testServlet = Mockito.mock(RequestAcceptServlet.class, Mockito.CALLS_REAL_METHODS);
    }

    @Before
    public void init() {
        Mockito.when(this.req.getRequestURI()).thenReturn("/request/accept/1");
        Mockito.when(this.session.getAttribute("user")).thenReturn(manager);
    }

    @Test
    public void testRequestAcceptFail_whenNoIDSupplied() throws ServletException, IOException {
        Mockito.when(this.req.getRequestURI()).thenReturn("/request/accept");
    ...
    @Test
    public void testRequestAcceptFail_whenIDTypeError() throws ServletException, IOException {
        Mockito.when(this.req.getRequestURI()).thenReturn("/request/accept/a");
        this.testServlet.doPost(this.req, this.resp);
    ...
    @Test
    public void testRequestAcceptFail_whenRequestResolved() throws ServletException, IOException {
    ...
    @Test
    public void testRequestAcceptFail_whenRequestNotFound() throws ServletException, IOException, RecordNotExistsException, IllegalArgumentException {
    ...
    @Test
    public void testRequestAcceptFail_whenUserNotFound() throws ServletException, IOException {
        Mockito.when(this.reimbursementRequestService.getReimbursementRequest(1)).thenReturn(Optional.of(Mockito.mock(PendingReimbursementRequest.class)));
    ...
    @Test
    public void testRequestAcceptSuccess() throws ServletException, IOException {
        Mockito.when(this.reimbursementRequestService.getReimbursementRequest(1)).thenReturn(Optional.of(Mockito.mock(PendingReimbursementRequest.class)));
